...
The resultant `census_get()` function is documented in the code chunk below. Note that there are five parameters consistent with our goals for the function:
...
test_response<-census_get(year=2018,catvar=c("SEX","HHL"),numvar=c("AGEP","JWAP","JWDP"),
